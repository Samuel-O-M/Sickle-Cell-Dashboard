    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Patient Lookup - moved to first position */}
          <div
          ...
          {/* Editing Dashboard - new third section */}
          <div
            onClick={() => navigate('/edit')}
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 cursor-pointer hover:shadow-md hover:border-amber-300 transition-all duration-200"
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Editing Dashboard</h3>
            <p className="text-gray-600 text-sm">
              Admin-only interface to modify clinical data directly
            </p>
          </div>

          {/* Clinical Dashboard - moved to fourth position */}
          <div
          ...
          {/* Fundraising Page - remains as fifth (but fourth in grid due to three columns) */}
          <div
            onClick={() => navigate('/')}
